...
export const fr = {
  common: {
    ...
    confirm: "Confirmer",
    login: "Se connecter",
    sent: "Validation envoyée",
    sentWaitingOthers: "Validation envoyée, en attente des autres.",
    tapNext: "Touchez pour passer à la suite.",
    percent: "{value} %",
  },
  app: {
    unknownState: "État de jeu inconnu",
  ...
  game: {
    ...
    yes: "Pour",
    no: "Contre",
    missionVotes: "votes : {nazi} nazi · {communist} communiste",
  },
  role: {
    nazi: "Nazi",
    ...
    unknown: "Inconnu",
    allies: "Alliés : {names}",
    onlyYou: "Rôle visible uniquement pour vous.",
  },
  history: {
    ...
    fullSubtitle: "Tous les votes et résultats",
    votes: "Votes de confiance",
  ...
  createRoom: {
    ...
    rules: "Règles",
    revealRoles: "Révéler les nazis à la fin de la partie",
    presetDuel: "2 joueurs (duel)",
    paceLabel: "Durée de partie",
    paceClassic: "Classique",
    paceQuick: "Rapide",
    paceClassicHint: "Premier camp à (joueurs ÷ 2) + 1 missions : 5 missions à 5 joueurs, 15 à 14. Environ 20 à 60 min.",
    paceQuickHint: "Toujours 5 missions, premier camp à 3, avec des équipes plus grandes quand on est nombreux. Environ 20 à 30 min.",
    rulesDefault: "Standard (de 3 à 14 joueurs, duel à 2)",
  ...
  waiting: {
    ...
    revealOn: "Nazis révélés à la fin",
    revealOff: "Rôles gardés secrets, même après la partie",
  ...
  confidence: {
    recorded: "Vote enregistré, en attente des autres joueurs.",
    title: "Vote de confiance",
    noTeam: "Aucune équipe",
    majorityYes: "Majorité POUR",
    majorityNo: "Majorité CONTRE",
    noVotes: "Aucun vote reçu",
  },
  mission: {
    waiting: "En attente.",
    victoryNazi: "Victoire nazie",
    victoryCommunist: "Victoire communiste",
    naziVotes: "Votes nazis : {count}",
    communistVotes: "Votes communistes : {count}",
  },
  endGame: {
    replaySent: "Choix « Rejouer » envoyé, en attente des autres joueurs.",
    forfeit: "Abandon de {name}",
    replayQuestion: "Rejouer ?",
    nazisWere: "Les nazis étaient : {names}",
    rolesPending: "Rôles à venir",
    naziAllies: "Alliés nazis : {names}",
    replay: "Rejouer",
  ...
  chat: {
    mutedUntil: "Chat coupé par la modération jusqu'au {date}",
    open: "Ouvrir le chat",
    title: "Chat",
  ...
  moderation: {
    title: "Modération",
    hint: "Conversations signalées, anonymisées. Choisis une conséquence pour un participant : le serveur l'applique à la bonne personne sans jamais te la révéler.",
    reportTrigger: "Signalé par {reporter} : {reason}",
    back: "← Tous les dossiers",
    participants: "Participants",
    account: "compte",
    guest: "invité",
    guestHint: "Joueur sans compte : aucune sanction durable possible.",
    prior: "{count} sanction(s) déjà reçue(s)",
    isBanned: "banni",
    isMuted: "chat coupé",
    requestPending: "demande de ban en attente",
    warn: "Avertir",
    mute1h: "Mute 1 h",
    mute24h: "Mute 24 h",
    chatBan7: "Ban du chat 7 j",
    chatBan30: "Ban du chat 30 j",
    banRequest: "Demander un ban définitif",
    reasonPrompt: "{action} pour {pseudonym} : motif (le joueur le verra) ?",
    applied: "{action} appliqué à {pseudonym}.",
    requestSent: "Demande de ban définitif envoyée à l'administrateur.",
    notePlaceholder: "Décision (résumé)",
    history: "Journal du dossier ({count})",
    sanctionMute: "Mute",
    sanctionChatBan: "Ban du chat",
    sanctionBan: "Bannissement",
    sanctionPermanentBan: "Ban définitif",
  },
  warning: {
  ...
  duel: {
    ...
    hint: "Vote secret. Communiste : il faut juger juste. Nazi : se faire accepter, ou trouver un autre nazi.",
    trust: "Confiance",
    accuse: "Nazi !",
    ...
    rulesIntro: "Chaque rôle est tiré à pile ou face : 25 % de deux communistes, 25 % de deux nazis, 50 % d'un de chaque. Ton rôle ne dit rien de celui de l'autre.",
    rulesCommunists: "Un communiste gagne s'il juge juste : confiance à un communiste, « Nazi ! » face à un nazi.",
    rulesMixed: "Un nazi face à un communiste gagne s'il se fait accepter (les deux font confiance). S'il accuse un communiste, il se démasque et perd.",
    rulesNazis: "Deux nazis : celui qui accuse a trouvé l'autre et gagne. S'ils s'accusent ou se font confiance tous les deux, ils gagnent ensemble.",
    reason: {
      ...
      nazi_gave_himself_away: "{nazi} a accusé un communiste et s'est démasqué, mais {communist} lui faisait confiance : personne ne gagne.",
      ...
      nazis_trusted_each_other: "Deux nazis qui se sont fait confiance : ils se reconnaissent, victoire commune.",
  ...
  errors: {
    ...
    chatMuted: "Ton chat est coupé par la modération pour le moment.",
  ...
  admin: {
    ...
    totpSetupRequired: "La modération demande la double authentification. Active-la dans les paramètres de sécurité de ton compte, puis reviens ici.",
    openSecurity: "Ouvrir mon profil",
    banPromptModerator: "Bannir {name} combien de jours ? (30 au plus, 0 = lever)",
    roleModerator: "modérateur",
    makeModerator: "Nommer modérateur",
    removeModerator: "Retirer le rôle de modérateur",
    makeModeratorConfirm: "Nommer {name} modérateur ? Il pourra lire les signalements, lever l'anonymat des dossiers (tracé) et sanctionner des comptes (30 jours au plus).",
    removeModeratorConfirm: "Retirer le rôle de modérateur à {name} ?",
    moderatorAdded: "Modérateur nommé.",
    moderatorRemoved: "Rôle retiré.",
    catRacism: "racisme",
    catAntisemitism: "antisémitisme",
    catHomophobia: "homophobie",
    catAbleism: "validisme",
    catThreats: "menaces",
    catSuicide: "incitation au suicide",
    catSexual: "harcèlement sexuel",
    catPersonalData: "données personnelles",
    tabBanRequests: "Demandes de ban",
    bannedForever: "Banni définitivement · {reason}",
    mutedUntil: "Chat coupé jusqu'au {date}",
    sanctionHistory: "Historique des sanctions ({count})",
    revoked: "(levée)",
    revokePermanent: "Abroger le ban définitif",
    clearSanctions: "Lever toutes les sanctions",
    clearSanctionsConfirm: "Lever toutes les sanctions de {name} (bannissement, chat coupé, avertissements) ?",
    sanctionsCleared: "Sanctions levées.",
    requestsPending: "En attente",
    requestsAccepted: "Acceptées",
    requestsRejected: "Refusées",
    noBanRequests: "Aucune demande.",
    requestedBy: "Demandé par {by} : « {reason} »",
    acceptBan: "Bannir définitivement",
    rejectBan: "Refuser",
    acceptBanConfirm: "Bannir définitivement {name} ? Ses sessions sont fermées tout de suite.",
    rejectBanConfirm: "Refuser la demande de ban définitif pour {name} ?",
    banAccepted: "Ban définitif appliqué.",
    banRejected: "Demande refusée.",
    decidedBy: "Décidé par {by}",
    tabModerators: "Modérateurs",
    moderatorsHint: "Les modérateurs traitent les signalements dans le panel de modération, sans jamais voir l'identité des joueurs. Ils doivent activer la double authentification dans leur profil.",
    moderatorsTeam: "Équipe de modération ({count})",
    noModerators: "Aucun modérateur pour l'instant.",
    appointModerator: "Nommer un modérateur",
    tabGames: "Parties",
    tabUsers: "Comptes",
